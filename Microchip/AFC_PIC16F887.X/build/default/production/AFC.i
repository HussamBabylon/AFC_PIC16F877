...
# 52 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\pic\include\proc\pic16f887.h"
...
unsigned long current_period = 130;


const unsigned long total_period = 2500;
...
LCD_Clear();
LCD_Set_Cursor(1, 1);
LCD_Write_String("  BMW AL MARWA");
LCD_Set_Cursor(2, 1);
LCD_Write_String("  07710854222");
RB1 = 1;
...
RT = VRT / (VR / 5500);
ln = log(RT / 5684);
Temperature = (1 / ((ln / 3965) + (1 / T0)));
Temperature = Temperature - 273.15;

_delay((unsigned long)((125)*(8000000/4000000.0)));
return Temperature;
